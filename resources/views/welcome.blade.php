...
<div class="max-w-[1440px] mx-auto px-12 py-8">
    ...
    <section class="relative mb-24 overflow-hidden rounded-[6px] bg-surface-container-low group">
        <div class="flex flex-col md:flex-row items-center">
            <div class="w-full md:w-1/2 p-12 md:p-20 order-2 md:order-1">
                ...
                <h1 class="font-headline font-black text-[48px] leading-[1.1] text-on-surface mb-6 tracking-tighter">{{ $featuredStory->title }}</h1>
                ...
                <div class="flex gap-4">
                    <button onclick="window.location.href='{{ route('story.show', $featuredStory->slug) }}'" class="bg-on-surface text-white px-8 py-4 rounded-[6px] font-bold text-sm flex items-center gap-2 hover:bg-black transition-colors">
                        Read Now
    ...
    <section class="mb-24">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div class="group cursor-pointer" onclick="window.location.href='{{ route('story.show', $story->slug) }}'">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-[10px] text-secondary/60 uppercase font-bold tracking-tighter">{{ $story->updated_at->diffForHumans() }}</span>
                </div>
            </div>
            @empty
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-24 mb-24">
        ...
        <section class="lg:col-span-2">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center gap-6 group cursor-pointer border-b border-surface-container pb-6 last:border-0" onclick="window.location.href='{{ route('story.show', $story->slug) }}'">
